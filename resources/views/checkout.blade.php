        ...
        <form action="{{ route('order') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_fullname"
                    class="form-control @error('shipping_fullname') is-invalid @enderror " id="" aria-describedby=""
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_state" class="form-control @error('shipping_state') is-invalid @enderror "
                    id="" aria-describedby="" placeholder="Enter your state">
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_city" class="form-control @error('shipping_city') is-invalid @enderror "
                    id="" aria-describedby="" placeholder="Enter your city">
                @error('shipping_city')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_zipcode"
                    class="form-control @error('shipping_zipcode') is-invalid @enderror " id="" aria-describedby=""
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_address"
                    class="form-control @error('shipping_address') is-invalid @enderror " id="" aria-describedby=""
            ...
            <div class="form-group">
                ...
                <input type="text" name="shipping_phone" class="form-control @error('shipping_phone') is-invalid @enderror "
                    id="" aria-describedby="" placeholder="Enter your mobile number">
